  ...
  return (
    <section className="relative bg-deep-black overflow-hidden bg-[url(./assets/images/graphic.png)] bg-center bg-no-repeat bg-cover">
      ...
      <div className="max-w-7xl mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 items-center min-h-130 lg:min-h-96 xxl:min-h-140 md:min-h-96 py-16 md:py-0">
          {/* LEFT TEXT */}
          ...
          <div className="relative flex justify-center md:justify-end mt-10 md:mt-0">
            <img
              src={hero}
              alt="BringMe Food"
              className="w-full max-w-sm sm:max-w-md md:max-w-none md:w-auto md:h-96  object-contain pointer-events-none"
            />
          </div>
        </div>
      </div>
